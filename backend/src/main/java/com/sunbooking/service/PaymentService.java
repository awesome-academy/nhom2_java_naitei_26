...
import com.sunbooking.dto.payment.PaymentResponse;
import com.sunbooking.entity.Booking;
import com.sunbooking.entity.Payment;
import com.sunbooking.repository.PaymentRepository;
...
public class PaymentService {
    ...
    public PaymentResponse createPayment(Booking booking) {
        ...
        String reference = sePayConfig.getQrPrefix() + booking.getId() + UUID.randomUUID().toString().substring(0, 4).toUpperCase();
