...
**Scale/Scope**: Greenfield implementation of User, Social Account, Category, Tour, Tour Image, Tour Departure, Place, Tour Place, Food, Booking, Booking Traveler, Payment, Review, Review Image, Review Like, Comment, News, Authentication, Authorization, Revenue reporting, Admin operations across both Frontend (UI) and Backend (API).
*Note: Bank Account management is temporarily excluded pending mentor confirmation.*
