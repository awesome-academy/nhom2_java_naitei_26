...
- [x] T041 [P] [US2] [BE-CONTENT] Create `Place` entity in `backend/src/main/java/com/sunbooking/domain/content/entity/Place.java`
- [x] T042 [P] [US2] [BE-CONTENT] Create `TourPlace` entity in `backend/src/main/java/com/sunbooking/domain/content/entity/TourPlace.java`
- [x] T043 [P] [US2] [BE-CONTENT] Create `Food` entity in `backend/src/main/java/com/sunbooking/domain/content/entity/Food.java`
- [x] T044 [P] [US2] [BE-CONTENT] Create `News` entity in `backend/src/main/java/com/sunbooking/domain/content/entity/News.java`
- [x] T045 [P] [US2] [BE-CONTENT] Create `PlaceRepository` in `backend/src/main/java/com/sunbooking/domain/content/repository/PlaceRepository.java`
- [x] T046 [P] [US2] [BE-CONTENT] Create `TourPlaceRepository` in `backend/src/main/java/com/sunbooking/domain/content/repository/TourPlaceRepository.java`
- [x] T047 [P] [US2] [BE-CONTENT] Create `FoodRepository` in `backend/src/main/java/com/sunbooking/domain/content/repository/FoodRepository.java`
- [x] T048 [P] [US2] [BE-CONTENT] Create `NewsRepository` in `backend/src/main/java/com/sunbooking/domain/content/repository/NewsRepository.java`
- [x] T049 [P] [US2] [BE-CONTENT] Create content DTOs in `backend/src/main/java/com/sunbooking/domain/content/dto/`
- [x] T050 [US2] [BE-CONTENT] Implement `PlaceService` in `backend/src/main/java/com/sunbooking/domain/content/service/PlaceService.java`
- [x] T051 [US2] [BE-CONTENT] Implement `FoodService` in `backend/src/main/java/com/sunbooking/domain/content/service/FoodService.java`
- [x] T052 [US2] [BE-CONTENT] Implement `NewsService` in `backend/src/main/java/com/sunbooking/domain/content/service/NewsService.java`
- [x] T053 [US2] [BE-CONTENT] Implement `ContentController` for public access in `backend/src/main/java/com/sunbooking/domain/content/controller/ContentController.java`
- [ ] T054 [P] [US2] [FE-TOUR] Implement content API clients in `frontend/src/features/{place,food,news}/services/`
- [x] T055 [P] [US2] [FE-TOUR] Create places page in `frontend/src/features/place/pages/PlaceList.tsx`
- [ ] T056 [P] [US2] [FE-TOUR] Create food presentation component in `frontend/src/features/food/components/FoodCard.tsx`
- [ ] T057 [P] [US2] [FE-TOUR] Create news list page in `frontend/src/features/news/pages/NewsListPage.tsx`
- [ ] T058 [P] [US2] [FE-TOUR] Create news detail page in `frontend/src/features/news/pages/NewsDetailPage.tsx`
