...
CREATE TABLE payment (
    ...
    -- Added because the provided ERD defines:
    -- BANK_ACCOUNT.bank_account_id < PAYMENT.bank_account_id
...
CREATE INDEX idx_payment_bank_account_id
    ON payment(bank_account_id);
